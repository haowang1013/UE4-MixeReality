...
public:
	...
	static void SetCaptureRenderTarget(class UTextureRenderTarget2D* NewTexture);

	UFUNCTION(BlueprintCallable, Category = "SteamVR")
	static void RemoveCaptureRenderTarget(class UTextureRenderTarget2D* NewTexture);
};
