...
#if 1 // MIXED-REALITY
	vr::IVRCompositor* GetCompositor() { return VRCompositor; }
	void SetCameraRenderTarget(class UTextureRenderTarget2D* target) 
	{ 
		vrCameraRenderTarget = target; 
	}

	void RemoveCameraRenderTarget(class UTextureRenderTarget2D* target)
	{
		if (vrCameraRenderTarget == target)
		{
			vrCameraRenderTarget = nullptr;
		}
	}
#endif
...
#if 1 // MIXED-REALITY
	class UTextureRenderTarget2D* vrCameraRenderTarget = nullptr;
#endif
};
